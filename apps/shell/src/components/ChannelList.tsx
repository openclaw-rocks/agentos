    ...
    <div className="w-60 flex-shrink-0 bg-surface-1 border-r border-border flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto py-2">
        ...
        {channels.map((room) => {
          ...
          const hasAgents = room.getJoinedMembers().some((m) => m.userId.includes("agent-"));
        ...
        {channels.length === 0 && (
          <p className="px-4 py-8 text-sm text-gray-500 text-center">No channels yet</p>
        )}
      </div>
    </div>
  );
